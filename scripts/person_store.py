...
def _parse_vitals(paren):
    ...
    if not born and not died:
        # Year fallback, used when the header carries no b./d. marker. The old
        # bound (1500-2029) silently returned NOTHING for medieval entries: 105 of
        # the 157 rows in the Magna Carta file had empty born/died purely because
        # their years are pre-1500 (1045, 1261, 1326, 1426). Now any 4-digit year.
        # Two things were tried and REJECTED on measurement:
        #   * allowing 3-digit years -> read atto/page numbers ("534") as death years;

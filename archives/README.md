...
Every archive guide must include YAML frontmatter:
...
Update `last_verified` whenever URLs, prices, access rules, or AI accessibility notes are checked. Genealogy databases change access rules often, so stale archive guidance should be treated as a lead, not as current truth.
